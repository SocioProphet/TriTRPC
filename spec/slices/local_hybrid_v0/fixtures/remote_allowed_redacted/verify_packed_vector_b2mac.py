...
This script re-derives the packed envelope from the JSON fixture bundle and
compares it to `packed-vector.b2mac.example.json` byte for byte.
"""
...
PACKER_PATH = FIXTURE_DIR / "pack_full_fixture_vector_b2mac.py"
...
def main() -> int:
    packer = load_module(PACKER_PATH, "pack_full_fixture_vector_b2mac")
