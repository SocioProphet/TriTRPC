...
This variant fixes the suite to the repository reference fallback MAC behavior so
that the packed artifact is stable across environments with and without optional
