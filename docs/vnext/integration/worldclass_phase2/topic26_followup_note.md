...
The earlier worldclass work moved from `topic23.proposed.v1` to a proposed `topic25` because two missing first-class lanes were repeatedly encountered:

1. temporal / CHRONOS-style semantics
2. environment / toolchain / boundary semantics

That move was a conservative minimum-change correction, not a wire-budget constraint.
